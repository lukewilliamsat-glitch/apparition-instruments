import {kitRecord,resolveLesPaulKit} from './config.mjs';
...
export function createKitSnapshot(value,drawing={}){
 const resolved=resolveLesPaulKit(value);
 if(resolved.availability.status!=='available')throw new Error('This kit contains out-of-stock or unavailable components. Choose an available configuration.');
