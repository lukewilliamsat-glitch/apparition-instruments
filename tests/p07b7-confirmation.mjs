...
const gate=fs.readFileSync('dist/admin/admin-gate.mjs','utf8'),app=fs.readFileSync('dist/admin/orders/app.mjs','utf8');assert.match(gate,/order-data\.mjs\?v=p08b2a/);assert.match(app,/order-data\.mjs\?v=p08b2a/);
